...
class Camera(Group):
    def __init__(self, *sprites: Any | AbstractGroup | Iterable) -> None:
        ...
        self.bg_surf = load_image("graphics/main/map.png").convert()
        self.fg_surf = load_image("graphics/main/overlay.png").convert_alpha()
    ...
    def customize_draw(self, surface: Surface, player: Player) -> None:
        ...
        surface.blit(self.fg_surf, -self.offset)
